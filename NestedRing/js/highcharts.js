	...
	var K = function() {
		...
		a.Fx.prototype = {
			dSetter: function() {
				...
				v;
				if (1 === t) l = this.toD;
				else if (n === f.length && 1 > t) for (; n--;) v = parseFloat(a[n]),
			...
			step: function(q) {
				...
				u = t.duration,
				c = t.curAnim;
				n.attr && !n.element ? q = !1 : q || f >= u + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), l = c[this.prop] = !0, a.objectEach(c,
				function(a) { ! 0 !== a && (l = !1)
			...
			initPath: function(q, f, l) {
				...
				function n(a, c) {
					for (; a.length < h;) {
						a[0] = c[h - a.length];
						var b = a.slice(0, d); [].splice.apply(a, [0, 0].concat(b));
						p && (b = a.slice(a.length - d), [].splice.apply(a, [a.length, 0].concat(b)), e--)
					}
					a[0] = "M"
				}
				function v(a, c) {
					for (var b = (h - a.length) / d; 0 < b && b--;) k = a.slice().splice(a.length / r - d, d * r),
					k[0] = c[h - d - b * d],
		...
		a.merge = function() {
			...
			n = function(l, q) {
				"object" !== typeof l && (l = {});
				a.objectEach(q,
				function(c, b) { ! a.isObject(c, !0) || a.isClass(c) || a.isDOMElement(c) ? l[b] = q[b] : l[b] = n(l[b] || {},
					c)
				});
				return l
		...
		a.attr = function(q, f, l) {
			var t;
			a.isString(f) ? a.defined(l) ? q.setAttribute(f, l) : q && q.getAttribute && (t = q.getAttribute(f)) : a.defined(f) && a.isObject(f) && a.objectEach(f,
			function(a, l) {
				q.setAttribute(l, a)
			});
			return t
		...
		a.normalizeTickInterval = function(q, f, l, t, n) {
			...
			l = a.pick(l, 1);
			v = q / l;
			f || (f = n ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === t && (1 === l ? f = a.grep(f,
			function(a) {
				return 0 === a % 1
			}) : .1 >= l && (f = [1 / l])));
		...
		a.numberFormat = function(q, f, l, t) {
			...
			u,
			c,
			b = q.toString().split("e"); - 1 === f ? f = Math.min(v, 20) : a.isNumber(f) ? f && b[1] && 0 > b[1] && (u = f + +b[1], 0 <= u ? (b[0] = ( + b[0]).toExponential(u).split("e")[0], f = u) : (b[0] = b[0].split(".")[0] || 0, q = 20 > f ? (b[0] * Math.pow(10, b[1])).toFixed(f) : 0, b[1] = 0)) : f = 2;
		...
		a.getStyle = function(q, f, l) {
			...
			if (q = E.getComputedStyle(q, void 0)) q = q.getPropertyValue(f),
		...
		a.fireEvent = function(q, f, l, t) {
			var n, v, u, c, b;
			l = l || {};
			H.createEvent && (q.dispatchEvent || q.fireEvent) ? (n = H.createEvent("Events"), n.initEvent(f, !0, !0), a.extend(n, l), q.dispatchEvent ? q.dispatchEvent(n) : q.fireEvent(f, n)) : a.each(["protoEvents", "hcEvents"],
			function(m) {
		...
		a.Color.prototype = {
			...
			init: function(l) {
				var f, n, v, u;
				if ((this.input = l = this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) && l.stops) this.stops = E(l.stops,
				function(c) {
					return new a.Color(c[1])
				});
				else if (l && l.charAt && "#" === l.charAt() && (f = l.length, l = parseInt(l.substr(1), 16), 7 === f ? n = [(l & 16711680) >> 16, (l & 65280) >> 8, l & 255, 1] : 4 === f && (n = [(l & 3840) >> 4 | (l & 3840) >> 8, (l & 240) >> 4 | l & 240, (l & 15) << 4 | l & 15, 1])), !n) for (v = this.parsers.length; v--&&!n;) u = this.parsers[v],
			...
			get: function(a) {
				...
				n = this.rgba,
				v;
				this.stops ? (v = q(l), v.stops = [].concat(v.stops), B(this.stops,
				function(n, c) {
			...
			brighten: function(a) {
				...
				else if (H(a) && 0 !== a) for (l = 0; 3 > l; l++) n[l] += f(255 * a),
				0 > n[l] && (n[l] = 0),
				255 < n[l] && (n[l] = 255);
				return this
			},
		...
		h(B.prototype, {
			...
			colorGradient: function(y, g, c) {
				...
				}), "radialGradient" === b && A && !u(e.gradientUnits) && (k = e, e = F(e, w.getRadialAttr(A, k), {
					gradientUnits: "userSpaceOnUse"
				})), J(e,
				function(a, y) {
					"id" !== y && r.push(y, a)
				...
				function(a) {
					r.push(a)
				}), r = r.join(","), p[r] ? A = p[r].attr("id") : (e.id = A = a.uniqueKey(), p[r] = Q = w.createElement(b).attr(e).add(w.defs), Q.radAttr = k, Q.stops = [], d(x,
				function(y) {
			...
			applyTextOutline: function(y) {
				...
				if ((h = y[0]) && "none" !== h && a.svg) {
					...
					for (b = y.length; b--;) c = y[b],
					"highcharts-text-outline" === c.getAttribute("class") && k(y, g.removeChild(c));
					e = g.firstChild;
					d(y,
					function(a, y) {
			...
			attr: function(a, g, c, w) {
				...
				b, e = this,
				d, k;
				"string" === typeof a && void 0 !== g && (y = a, a = {},
				a[y] = g);
				"string" === typeof a ? e = (this[a + "Getter"] || this._defaultGetter).call(this, a, h) : (J(a,
				function(y, g) {
					d = !1;
					w || L(this, g);
					this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(g) && (b || (this.symbolAttr(a), b = !0), d = !0); ! this.rotation || "x" !== g && "y" !== g || (this.doTransform = !0);
			...
			updateShadows: function(a, g, c) {
				...
				w = y.length; w--;) c.call(y[w], "height" === a ? Math.max(g - (y[w].cutHeight || 0), 0) : "d" === a ? this.d: g, a, y[w])
			},
			...
			css: function(a) {
				...
				J(a,
				function(a, y) { - 1 === r(y, p) && (e += y.replace(/([A-Z])/g, d) + ":" + a + ";")
			...
			on: function(a, g) {
				...
				c.onclick = function(a) { ( - 1 === R.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (y.touchEventFired || 0)) && g.call(c, a)
				}) : c["on" + a] = g;
				return this
			},
			...
			updateTransform: function() {
				...
				h ? a.push("rotate(90) scale(-1,1)") : e && a.push("rotate(" + e + " " + G(this.rotationOriginX, d.getAttribute("x"), 0) + " " + G(this.rotationOriginY, d.getAttribute("y") || 0) + ")"); (u(c) || u(w)) && a.push("scale(" + G(c, 1) + " " + G(w, 1) + ")");
			...
			align: function(a, g, c) {
				...
				var b, p;
				if (a) {
					if (this.alignOptions = a, this.alignByTranslate = g, !c || C(c)) this.alignTo = y = c || "renderer",
					k(h, this),
					h.push(this),
					c = null
			...
			getBBox: function(a, g) {
				...
				if (!y) {
					if (e.namespaceURI === this.SVG_NS || w.forExport) {
						try { (N = this.fakeTS &&
							function(a) {
								d(e.querySelectorAll(".highcharts-text-outline"),
								function(y) {
									y.style.display = a
								})
							}) && N("none"),
			...
			destroy: function() {
				...
				L(a);
				h && w && (d(w.querySelectorAll("[clip-path],[CLIP-PATH]"),
				function(a) {
					var g = a.getAttribute("clip-path"),
					y = h.element.id; ( - 1 < g.indexOf("(#" + y + ")") || -1 < g.indexOf('("#' + y + '")')) && a.removeAttribute("clip-path")
				...
				a.safeRemoveChild(g);
				for (a.destroyShadows(); c && c.div && 0 === c.div.childNodes.length;) g = c.parentGroup,
			...
			shadow: function(a, g, c) {
				...
				if (!a) this.destroyShadows();
					...
					c && (f(h, "height", Math.max(f(h, "height") - b, 0)), h.cutHeight = b),
					g ? g.element.appendChild(h) : e.parentNode && e.parentNode.insertBefore(h, e),
					y.push(h);
					this.shadows = y
				}
				return this
			...
			zIndexSetter: function(a, c) {
				...
				if (e) { (a = this.zIndex) && y && (y.handleZ = !0);
					c = h.childNodes;
					for (p = c.length - 1; 0 <= p && !d; p--) if (y = c[p], e = y.zIndex, k = !u(e), y !== b) if (0 > a && k && !w && !p) h.insertBefore(b, c[p]),
					d = !0;
					else if (g(e) <= a || k && (!u(a) || 0 <= a)) h.insertBefore(b, c[p + 1] || null),
					d = !0;
		...
		h(H.prototype, {
			...
			buildText: function(a) {
				...
				if (M !== a.textCache) {
					...
					y || D || C || O || -1 !== b.indexOf(" ") ? (p = /<.*class="([^"]+)".*>/, x = /<.*style="([^"]+)".*>/, A = /<.*href="([^"]+)".*>/, L && L.appendChild(c), b = y ? b.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [b], b = e(b,
					function(a) {
						return "" !== a
					}), d(b,
					function(g, b) {
						...
						function(g) {
							if ("" !== g || 1 === e.length) {
								...
								A.test(g) && !h && (f(k, "onclick", 'location.href\x3d"' + g.match(A)[1] + '"'), f(k, "class", "highcharts-anchor"), n(k, {
									cursor: "pointer"
								}));
								...
								if (" " !== g) {
									...
									if (O) {
										...
										J = R(k),
										G = a.rotation;
										for (C && (F = w.applyEllipsis(a, k, g, O)); ! C && r && (d.length || l.length);) a.rotation = 0,
										...
										g && 1 !== d.length ? (k.removeChild(k.firstChild), l.unshift(d.pop())) : (d = l, l = [], d.length && !v && (k = m.createElementNS(N, "tspan"), f(k, {
											dy: J,
											x: z
										}), L && f(k, "style", L), c.appendChild(k)), D > O && (O = D)),
										d.length && k.appendChild(m.createTextNode(d.join(" ").replace(/- /g, "-")));
										a.rotation = G
									}
									y++
								}
			...
			button: function(a, g, c, w, b, d, e, k, p) {
				...
				r = k.style;
				delete k.style;
				E(y.element, M ? "mouseover": "mouseenter",
				function() {
					3 !== x && y.setState(1)
				});
				E(y.element, M ? "mouseout": "mouseleave",
				function() {
					3 !== x && y.setState(x)
				});
			...
			htmlUpdateTransform: function() {
				if (this.added) {
					...
					if ("SPAN" === b.tagName) {
						...
						A; (A = x !== this.oldTextWidth) && !(A = x > this.oldTextWidth) && ((A = this.textPxLength) || (E(b, {
							width: "",
							whiteSpace: C || "nowrap"
		...
		a.Time.prototype = {
			...
			update: function(n) {
				...
				u = this;
				this.options = n = q(!0, this.options || {},
				n);
				this.Date = n.Date || t.Date;
				this.timezoneOffset = (this.useUTC = l) && n.timezoneOffset;
				this.getTimezoneOffset = this.timezoneOffsetFunction(); (this.variableTimezone = !(l && !n.getTimezoneOffset && !n.timezone)) || this.timezoneOffset ? (this.get = function(a, b) {
					var c = b.getTime(),
				...
				this.set = function(c, b, m) {
					var d;
					if ( - 1 !== a.inArray(c, ["Milliseconds", "Seconds", "Minutes"])) b["set" + c](m);
					else d = u.getTimezoneOffset(b),
					d = b.getTime() - d,
					b.setTime(d),
					b["setUTC" + c](m),
			...
			getTimeTicks: function(a, v, u, c) {
				...
				if (B(v)) {
					...
					k = k.getTime();
					for (v = 1; k < u;) m.push(k),
					k = e === l.year ? b.makeTime(h + v * p, 0) : e === l.month ? b.makeTime(h, c + v * p) : !r || e !== l.day && e !== l.week ? r && e === l.hour && 1 < p ? b.makeTime(h, c, n, z + v * p) : k + e * p: b.makeTime(h, c, n + v * p * (e === l.day ? 1 : 7)),
					v++;
					m.push(k);
					e <= l.hour && 1E4 > m.length && H(m,
					function(a) {
		...
		a.Tick.prototype = {
			...
			handleOverflow: function(a) {
				...
				else if (b = c + (1 - e) * p, c - e * p < d ? I = a.x + I * (1 - e) - d: b > m && (I = m - a.x + I * e, z = -1), I = Math.min(r, I), I < r && "center" === f.labelAlign && (a.x += z * (r - I - e * (r - Math.min(p, I)))), p > I || f.autoRotation && (h.styles || {}).width) M = I;
	...
	var V = function(a) {
		...
		a.extend(G.prototype, {
			...
			defaultLabelFormatter: function() {
				...
				else if (x && 1E3 <= g) for (; x--&&void 0 === r;) b = Math.pow(k, x + 1),
				g >= b && 0 === 10 * c % b && null !== p[x] && 0 !== c && (r = a.numberFormat(c / b, -1) + p[x]);
			...
			getSeriesExtremes: function() {
				...
				function(g) {
					if (g.visible || !b.options.chart.ignoreHiddenSeries) {
						...
						c.length && (g = q(c), d = E(c), r(g) || g instanceof Date || (c = k(c, r), g = q(c), d = E(c)), c.length && (a.dataMin = Math.min(C(a.dataMin, c[0], g), g), a.dataMax = Math.max(C(a.dataMax, c[0], d), d)));
						else if (g.getExtremes(), d = g.dataMax, g = g.dataMin, n(g) && n(d) && (a.dataMin = Math.min(C(a.dataMin, g), g), a.dataMax = Math.max(C(a.dataMax, d), d)), n(w) && (a.threshold = w), !c.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
					}
				})
			},
			...
			getMinorTickPositions: function() {
				...
				k = a.max + k,
				x = k - p;
				if (x && x / e < a.len / 3) if (a.isLog) c(this.paddedTicks,
				function(g, c, b) {
			...
			adjustForMinRange: function() {
				...
				d = this.max,
				e, h, k, p, x, r, m, A;
				this.isXAxis && void 0 === this.minRange && !this.isLog && (n(a.min) || n(a.max) ? this.minRange = null: (c(this.series,
				function(a) {
					r = a.xData;
			...
			getClosest: function() {
				...
				function(g) {
					...
					b = g.visible || !g.chart.options.chart.ignoreHiddenSeries; ! g.noSharedTooltip && n(c) && b && (a = n(a) ? Math.min(a, c) : c)
				});
				return a
			},
			nameToX: function(a) {
			...
			updateNames: function() {
				var g = this,
				b = this.names;
				0 < b.length && (c(a.keys(b.keys),
				function(a) {
					delete b.keys[a]
				}), b.length = 0, this.minRange = this.userMinRange, c(this.series || [],
				function(a) {
					a.xIncrement = null;
			...
			setAxisTranslation: function(a) {
				...
				r = g.transA,
				m = g.isXAxis;
				if (m || x || d) e = g.getClosest(),
				p ? (h = p.minPointOffset, k = p.pointRangePadding) : c(g.series,
				function(a) {
			...
			setTickInterval: function(g) {
				...
				b.adjustForMinRange(); ! (G || b.axisPointRange || b.usePercentage || F) && n(b.min) && n(b.max) && (p = b.max - b.min) && (!n(I) && z && (b.min -= p * z), !n(B) && f && (b.max += p * f));
				...
				g = C(e.minTickInterval, b.isDatetimeAxis && b.closestPointRange); ! D && b.tickInterval < g && (b.tickInterval = g);
			...
			alignToOthers: function() {
				var a = {},
				b, d = this.options; ! 1 === this.chart.options.chart.alignTicks || !1 === d.alignTicks || this.isLog || c(this.chart[this.coll],
				function(g) {
					var c = g.options,
			...
			zoom: function(a, b) {
				...
				if (a !== this.min || b !== this.max) this.allowZoomOutside || (n(g) && (a < e && (a = e), a > d && (a = d)), n(c) && (b < e && (b = e), b > d && (b = d))),
			...
			tickSize: function(a) {
				...
				if (g && c) return "inside" === b[a + "Position"] && (c = -c),
				[c, g]
			},
			...
			unsquish: function() {
				...
				b ? (A = !a.staggerLines && !a.step && (n(p) ? [p] : h < C(a.autoRotationLimit, 80) && a.autoRotation)) && c(A,
				function(a) {
					var b;
					if (a === p || a && -90 <= a && 90 >= a) r = F(Math.abs(x.h / Math.sin(v * a))),
					b = r + Math.abs(a / 360),
					b < m && (m = b, k = a, e = r)
				}) : a.step || (e = F(x.h));
				this.autoRotation = A;
			...
			renderUnsquish: function() {
				...
				c(d,
				function(a) { (a = e[a]) && a.label && a.label.textPxLength > f && (f = a.label.textPxLength)
				});
				this.maxLabelLength = f;
				if (this.autoRotation) f > x && f > m.h ? r.rotation = this.labelRotation: this.labelRotation = 0;
				else if (p && (F = x, !A)) for (l = "clip", x = d.length; ! k && x--;) if (z = d[x], z = e[z].label) z.styles && "ellipsis" === z.styles.textOverflow ? z.css({
					textOverflow: "clip"
			...
			getOffset: function() {
				...
				function(b, c) {
					...
					1 : "left",
					3 : "right"
				} [x] === a.labelAlign, C(J.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && c(h,
				function(a) {
					G = Math.max(k[a].getLabelSize(), G)
				}), a.staggerLines && (G *= a.staggerLines), a.labelOffset = G * (a.opposite ? -1 : 1)) : D(k,
				function(a, b) {
					a.destroy();
					delete k[b]
				});
			...
			render: function() {
				...
				if (b.hasData() || p) b.minorTickInterval && !b.categories && c(b.getMinorTickPositions(),
				function(a) {
					b.renderMinorTick(a)
				}),
				x.length && (c(x,
				...
				b._addedPlotLB || (c((e.plotLines || []).concat(e.plotBands || []),
				function(a) {
		...
		B.prototype.getLogTickPositions = function(a, t, n, v) {
			...
			d = this.getLinearTickPositions(a, t, n);
			else if (.08 <= a) for (var c = Math.floor(t), h, k, e, p, r, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < n + 1 && !r; c++) for (k = l.length, h = 0; h < k && !r; h++) e = m(b(c) * l[h]),
			...
			a = f("auto" === a ? null: a, this._minorAutoInterval, l.tickPixelInterval / (v ? 5 : 1) * (n - t) / ((v ? c / this.tickPositions.length: c) || 1)),
			a = q(a, null, H(a)),
		...
		a.PlotLineOrBand.prototype = {
			render: function() {
				...
				A.zIndex = x;
				G += "-" + x; (C = c.plotLinesAndBandsGroups[G]) || (c.plotLinesAndBandsGroups[G] = C = J.g("plot-" + G).attr(A).add());
		...
		a.extend(B.prototype, {
			getPlotBandPath: function(a, c) {
				...
				if (m && b) for (a && (e = m.toString() === b.toString(), k = 0), a = 0; a < m.length; a += 6) h && b[a + 1] === m[a + 1] ? (b[a + 1] += k, b[a + 4] += k) : h || b[a + 2] !== m[a + 2] || (b[a + 2] += k, b[a + 5] += k),
				d.push("M", m[a + 1], m[a + 2], "L", m[a + 4], m[a + 5], b[a + 4], b[a + 5], b[a + 1], b[a + 2], "z"),
				d.flat = e;
				return d
			},
			...
			removePlotBandOrLine: function(a) {
				...
				b = this.options,
				m = this.userOptions,
				d = c.length; d--;) c[d].id === a && c[d].destroy();
				l([b.plotLines || [], m.plotLines || [], b.plotBands || [], m.plotBands || []],
				function(b) {
		...
		a.Tooltip.prototype = {
			...
			getPosition: function(a, b, m) {
				...
				x = function() { ! 1 !== n.apply(0, r) ? !1 !== D.apply(0, f) || p || (C(!0), x()) : p ? k.x = k.y = 0 : (C(!0), x())
			...
			refresh: function(a, b) {
				...
				var p = this.shared,
				f;
				d.enabled && (clearTimeout(this.hideTimer), this.followPointer = n(k)[0].series.tooltipOptions.followPointer, e = this.getAnchor(k, b), b = e[0], h = e[1], !p || k.series && k.series.noSharedTooltip ? p = k.getLabelConfig() : (B(k,
				function(a) {
					a.setState("hover");
			...
			tooltipFooterHeaderFormatter: function(a, b) {
				...
				e && h && B(a.point && a.point.tooltipDateKeys || ["key"],
				function(a) {
		...
		a.Pointer.prototype = {
			...
			getHoverData: function(c, h, k, f, m, l, n) {
				...
				p = n && n.isBoosting;
				f = !(!f || !c);
				n = h && !h.stickyTracking ? [h] : a.grep(k,
				function(a) {
				...
				e && (m && !h.noSharedTooltip ? (n = a.grep(k,
				function(a) {
			...
			runPointActions: function(b, c) {
				...
				this.unDocMouseMove || (this.unDocMouseMove = B(e.container.ownerDocument, "mousemove",
				function(b) {
			...
			reset: function(a, b) {
				...
				if (a) p && f && (p.refresh(f), e && (e.setState(e.state, !0), t(c.axes,
				function(a) {
		...
		E(a.Pointer.prototype, {
			...
			pinchTranslateDirection: function(a, f, l, q, c, b, m, d) {
				...
				g = !F && l[1][p],
				w;
				l = function() { ! F && 20 < Math.abs(A - G) && (D = d || Math.abs(J - g) / Math.abs(A - G));
					t = (n - J) / D + A;
			...
			pinch: function(a) {
				...
				"touchstart" === a.type ? (H(c,
				function(a, b) {
					u[b] = {
						chartX: a.chartX,
						chartY: a.chartY
					}
				}), m.x = [u[0].chartX, u[1] && u[1].chartX], m.y = [u[0].chartY, u[1] && u[1].chartY], H(t.axes,
				function(a) {
					if (a.zoomEnabled) {
		...
		a.Legend.prototype = {
			init: function(a, b) {
				this.chart = a;
				this.setOptions(b);
				b.enabled && (this.render(), B(this.chart, "endResize",
				function() {
			...
			positionItem: function(a) {
				...
				f = d[0],
				d = d[1],
				m = a.checkbox; (a = a.legendGroup) && a.element && a.translate(b ? f: this.legendWidth - f - 2 * c - 4, d);
				m && (m.x = f, m.y = d)
			},
			...
			renderItem: function(a) {
				...
				G || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + w.type + "-series highcharts-color-" + a.colorIndex + (O ? " " + O: "") + (g ? " highcharts-series-" + a.index: "")).attr({
					zIndex: 1
			...
			adjustMargins: function(a, b) {
				...
				d = this.options,
				h = this.getAlignment();
				h && f([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/],
				function(e, k) {
			...
			handleOverflow: function(a) {
				...
				l && (c = Math.min(c, l));
				A.length = 0;
				a > c && !1 !== D.enabled ? (this.clipHeight = z = Math.max(c - 20 - this.titleHeight - n, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, f(G,
				function(a, b) {
					var c = a._legendItemPos[1],
					d = Math.round(a.legendItem.getBBox().height),
					g = A.length;
					if (!g || c - A[g - 1] > z && (J || c) !== A[g - 1]) A.push(J || c),
					g++;
					a.pageIx = g - 1;
					J && (G[b - 1].pageIx = g - 1);
					...
					zIndex: 1
				}).add(this.group), this.up = d.symbol("triangle", 0, 0, x, x).on("click",
				function() {
					b.scroll( - 1, t)
		...
		}; (/Trident\/7\.0/.test(b.navigator.userAgent) || l) && m(a.Legend.prototype, "positionItem",
		function(a, b) {
			var c = this,
			d = function() {
		...
		d(P.prototype, {
			...
			redraw: function(b) {
				...
				k(this, "predraw");
				m(g,
				function(a) { (A || a.isDirty) && a.visible && a.redraw();
					a.isDirtyData = !1
				});
				e && e.reset(!0);
				n.draw();
			...
			layOutTitles: function(a) {
				...
				this.titleOffset = b; ! this.isDirtyBox && c && (this.isDirtyBox = c, this.hasRendered && F(a, !0) && this.isDirtyBox && this.redraw())
			},
			...
			reflow: function(c) {
				...
				if (!h && !g.isPrinting && k && d && (e === L || e === f)) {
					if (k !== g.containerWidth || d !== g.containerHeight) clearTimeout(g.reflowTimeout),
					g.reflowTimeout = w(function() {
			...
			setSize: function(b, g, d) {
				...
				e.getChartSize();
				b = h.globalAnimation; (b ? H: c)(e.container, {
			...
			drawChartBox: function() {
				...
				if (f || d["stroke-width"]) m.stroke = a.borderColor,
				m["stroke-width"] = f;
		...
		a.Point.prototype = {
			...
			optionsToObject: function(a) {
				...
				else if (t(a)) for (!d && a.length > k && (c = typeof a[0], "string" === c ? b.name = a[0] : "number" === c && (b.x = a[0]), e++); f < k;) d && void 0 === a[e] || (b[h[f]] = a[e]),
				e++,
				f++;
			...
			firePointEvent: function(a, b, m) {
				var c = this,
				h = this.series.options; (h.point.events[a] || c.options && c.options.events && c.options.events[a]) && this.importEvents();
		...
		},
		{
			...
			bindAxes: function() {
				...
				function(h) {
					...
					function(a) {
						e = a.options;
						if (c[h] === e.index || void 0 !== c[h] && c[h] === e.id || void 0 === c[h] && 0 === e.index) b.insert(a.series),
						b[h] = a,
						a.isDirty = !0
					});
			...
			setData: function(b, c, e, f) {
				...
				x = b.length;
				c = r(c, !0);
				if (!1 !== f && x && l === x && !m.cropped && !m.hasGroupedData && m.visible) v(b,
				function(a, b) {
					...
					m.xIncrement = null;
					m.colorCounter = 0;
					v(this.parallelArrays,
					function(a) {
						m[a + "Data"].length = 0
					});
					if (z && x > z) {
						for (e = 0; null === n && e < x;) n = b[e],
						e++;
						if (h(n)) for (e = 0; e < x; e++) q[e] = this.autoIncrement(),
						D[e] = b[e];
						else if (d(n)) if (t) for (e = 0; e < x; e++) n = b[e],
						q[e] = n[0],
						D[e] = n.slice(1, t + 1);
						else for (e = 0; e < x; e++) n = b[e],
						q[e] = n[0],
						D[e] = n[1];
						else a.error(12)
					} else for (e = 0; e < x; e++) void 0 !== b[e] && (n = {
						series: m
					},
			...
			processData: function(b) {
				...
				if (p && this.sorted && !x && (!m || e > m || this.forceCrop)) if (c[e - 1] < z || c[0] > q) c = [],
				d = [];
				else if (c[0] < z || c[e - 1] > q) h = this.cropData(this.xData, this.yData, z, q),
				c = h.xData,
				d = h.yData,
				h = h.start,
				g = !0;
				for (m = c.length || 1; --m;) e = n ? l(c[m]) - l(c[m - 1]) : c[m] - c[m - 1],
				0 < e && (void 0 === k || e < k) ? k = e: 0 > e && r && (a.error(15), r = !1);
				this.cropped = g;
				this.cropStart = h;
			...
			generatePoints: function() {
				...
				for (r = 0; r < k; r++) m = f + r,
				l ? (p = (new h).init(this, [e[r]].concat(z(g[r]))), p.dataGroup = this.groupMap[r]) : (p = c[m]) || void 0 === b[m] || (c[m] = p = (new h).init(this, b[m], e[r])),
				p && (p.index = m, n[r] = p);
				this.options.keys = a;
				if (c && (k !== (d = c.length) || l)) for (r = 0; r < d; r++) r !== f || l || (r += k),
			...
			getExtremes: function(a) {
				...
				e = a.length;
				for (n = 0; n < e; n++) if (p = c[n], x = a[n], l = (h(x, !0) || d(x)) && (!b.positiveValuesOnly || x.length || 0 < x), p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[n + 1] || p) >= f && (c[n - 1] || p) <= m, l && p) if (l = x.length) for (; l--;)"number" === typeof x[l] && (k[g++] = x[l]);
				else k[g++] = x;
				this.dataMin = q(k);
				this.dataMax = E(k)
			},
			...
			setClip: function(a) {
				...
				f = b[k],
				m = b[k + "m"];
				f || (a && (h.width = 0, d && (h.x = b.plotSizeX), b[k + "m"] = m = e.clipRect(d ? b.plotSizeX + 99 : -99, d ? -b.plotLeft: -b.plotTop, 99, d ? b.chartWidth: b.chartHeight)), b[k] = f = e.clipRect(h), f.count = {
					length: 0
				});
				a && !f.count[this.index] && (f.count[this.index] = !0, f.count.length += 1); ! 1 !== c.clip && (this.group.clip(a || g ? f: b.clipRect), this.markerGroup.clip(m), this.sharedClipKey = k);
			...
			drawPoints: function() {
				...
				m = e.isInside,
				d && !e.isNull ? (d = r(k.symbol, this.symbol), p = this.markerAttribs(e, e.selected && "select"), g ? g[m ? "show": "hide"](!0).animate(p) : m && (0 < p.width || e.hasImage) && (e.graphic = g = b.renderer.symbol(d, p.x, p.y, p.width, p.height, f ? k: h).add(l)), g && g.attr(this.pointAttribs(e, e.selected && "select")), g && g.addClass(e.getClassName(), !0)) : g && (e.graphic = g.destroy())
			},
			...
			pointAttribs: function(a, b) {
				...
				e = r(b.lineWidth, c.lineWidth, e + r(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, g = b.lineColor || c.lineColor || g);
				return {
					stroke: g,
					"stroke-width": e,
					fill: a
			...
			destroy: function() {
				...
				I(a);
				v(a.axisTypes || [],
				function(b) { (f = a[b]) && f.series && (u(f.series, a), f.isDirty = f.forceRedraw = !0)
				});
			...
			getGraphPath: function(a, b, c) {
				...
				function(h, l) {
					var p = h.plotX,
					x = h.plotY,
					r = a[l - 1]; (h.leftCliff || r && r.rightCliff) && !c && (m = !0);
			...
			applyZones: function() {
				...
				u,
				M = !1;
				e.length && (f || m) && p && void 0 !== p.min && (z = p.reversed, D = p.horiz, f && f.hide(), m && m.hide(), n = p.getExtremes(), v(e,
				function(e, x) {
			...
			render: function() {
				...
				a.invertGroups(l); ! 1 === d.clip || a.sharedClipKey || f || e.clip(c.clipRect);
				h && a.animate();
		...
		a.StackItem.prototype = {
			...
			setOffset: function(a, b) {
				...
				if (b = this.label) b.align(this.alignOptions, null, h),
				h = b.alignAttr,
				b[!1 === this.options.crop || d.isInsidePlot(h.x, h.y) ? "show": "hide"](!0)
			},
		...
		H.prototype.getStacks = function() {
			...
			l(a.series,
			function(b) { ! b.options.stacking || !0 !== b.visible && !1 !== a.options.chart.ignoreHiddenSeries || (b.stackKey = b.type + v(b.options.stack, ""))
			})
		};
		...
		B.prototype.cleanStacks = function() {
			var a;
			this.isXAxis || (this.oldStacks && (a = this.stacks = this.oldStacks), n(a,
			function(a) {
				n(a,
				function(a) {
		...
		u.prototype.setStackedPoints = function() {
			if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
				...
				A = (F = z && w < (e ? 0 : k)) ? t: n,
				D[A] || (D[A] = {}),
				D[A][g] || (C[A] && C[A][g] ? (D[A][g] = C[A][g], D[A][g].total = null) : D[A][g] = new a.StackItem(u, u.options.stackLabels, F, g, l)),
				A = D[A][g],
				null !== w ? (A.points[J] = A.points[this.index] = [v(A.cumulative, e)], q(A.cumulative) || (A.base = J), A.touched = u.stacksTouched, 0 < x.index && !1 === this.singleStacks && (A.points[J][0] = A.points[this.index + "," + g + ",0"][0])) : A.points[J] = A.points[this.index] = null,
				"percent" === h ? (F = F ? n: t, z && D[F] && D[F][g] ? (F = D[F][g], A.total = F.total = Math.max(F.total, A.total) + Math.abs(w) || 0) : A.total = E(A.total + (Math.abs(w) || 0))) : A.total = E(A.total + (w || 0)),
		...
		u.prototype.modifyStacks = function() {
			...
			function(b) {
				for (var c = d.length,
				e, l; c--;) if (e = d[c], h = a.getStackIndicator(h, e, a.index, b), l = (e = f[b] && f[b][e]) && e.points[h.key]) a[k + "Stacker"](l, e, c)
			})
		};
		...
		u.prototype.getStackIndicator = function(a, b, f, d) { ! q(a) || a.x !== b || d && a.key !== d ? a = {
				x: b,
				index: 0,
				key: d
			}: a.index++;
		...
		v(a.Chart.prototype, {
			...
			update: function(a, d, f) {
				...
				if (n) {
					...
					if ("inverted" in n || "polar" in n) p.propFromSeries(),
					r = !0;
					"alignTicks" in n && (r = !0);
					k(n,
					function(a, b) { - 1 !== c("chart." + b, p.propsRequireUpdateSeries) && (g = !0); - 1 !== c(b, p.propsRequireDirtyBox) && (p.isDirtyBox = !0)
					});
				...
				function(b) {
					a[b] && (t(M(a[b]),
					function(a, c) { (c = l(a.id) && p.get(a.id) || p[b][c]) && c.coll === b && (c.update(a, !1), f && (c.touched = !0));
		...
		v(p.prototype, {
			update: function(a, b, c, d) {
				...
				p, l = f.chart,
				n = f.options;
				b = e(b, !0); ! 1 === d ? h() : k.firePointEvent("update", {
					options: a
				},
				h)
			},
		...
		v(r.prototype, {
			...
			remove: function(a, b, c) {
				...
				var h = this,
				k = h.chart; ! 1 !== c ? u(h, "remove", null, d) : d()
			},
			update: function(a, b) {
				var c = this,
				d = c.chart,
		...
		},
		{
			...
			getStackPoints: function(f) {
				...
				if (this.options.stacking) {
					for (r = 0; r < f.length; r++) f[r].leftNull = f[r].rightNull = null,
					m[f[r].x] = f[r];
					a.objectEach(b,
					function(a, b) {
					...
					function(a, h) {
						var f = 0,
						n, z;
						if (m[a] && !m[a].isNull) l.push(m[a]),
						H([ - 1, 1],
						function(c) {
							var f = 1 === c ? "rightNull": "leftNull",
							l = 0,
							q = b[t[h + c]];
							if (q) for (r = d; 0 <= r && r < k;) n = q.points[r],
							n || (r === d ? m[a][f] = !0 : e[r] && (z = b[a].points[r]) && (l -= z[1] - z[0])),
							r += p;
			...
			getGraphPath: function(a) {
				...
				for (b = 0; b < a.length; b++) if (m = a[b].isNull, e = q(a[b].rectPlotX, a[b].plotX), z = q(a[b].yBottom, I), !m || t) t || M(b, b - 1, "left"),
				m && !u && t || (h.push(a[b]), d.push({
					x: b,
					plotX: e,
					plotY: z
				})),
			...
			drawGraph: function() {
				...
				function(c) {
					var b = c[0],
					f = a[b];
					f ? (f.endX = a.preventGraphAnimation ? null: l.xMap, f.animate({
						d: l
		...
		},
		{
			...
			getColumnMetrics: function() {
				...
				h = f.reversed,
				k, e = {},
				l = 0; ! 1 === b.grouping ? l = 1 : E(a.chart.series,
				function(b) {
					var c = b.options,
					h = b.yAxis,
					f;
		...
		},
		{
			...
			setVisible: function(a, b) {
				...
				b = v(b, h);
				a !== c.visible && (c.visible = c.options.visible = a = void 0 === a ? !c.visible: a, e.options.data[t(c, e.data)] = c.options, q(["graphic", "dataLabel", "connector", "shadowGroup"],
				function(b) {
		...
		b.prototype.drawDataLabels = function() {
			...
			A = e.renderer;
			if (f.enabled || c._hasPointLabels) c.dlProcessOptions && c.dlProcessOptions(f),
			x = c.plotGroup("dataLabelsGroup", "data-labels", F && !v ? "hidden": "visible", f.zIndex || 6),
			F && (x.attr({
				opacity: +v
			}), v || B(c, "afterAnimate",
			function() {
			...
			function(h) {
				...
				r = !g,
				v;
				z = h.dlOptions || h.options && h.options.dataLabels; (k = u(z && z.enabled, t.enabled) && !h.isNull) && (k = !0 === b(h, z || f));
		...
		m.pie && (m.pie.prototype.drawDataLabels = function() {
			...
			K,
			y = [0, 0, 0, 0];
			c.visible && (l.enabled || c._hasPointLabels) && (q(d,
			function(a) {
			...
			}), b.prototype.drawDataLabels.apply(c), q(d,
			function(a) {
			...
			function(b, d) {
				...
				p = [],
				r;
				if (n) for (c.sortByAngle(b, d - .5), 0 < c.maxLabelDistance && (h = Math.max(0, A - F - c.maxLabelDistance), k = Math.min(A + F + c.maxLabelDistance, f.plotHeight), q(b,
				function(a) {
				...
				}), a.distribute(p, k + r - h)), K = 0; K < n; K++) e = b[K],
				k = e.positionsIndex,
				g = e.labelPos,
				B = e.dataLabel,
				O = !1 === e.visible ? "hidden": "inherit",
				N = h = g[1],
				p && E(p[k]) && (void 0 === p[k].pos ? O = "hidden": (w = p[k].size, N = e.top + p[k].pos)),
				delete e.positionIndex,
				P = l.justify ? x[0] + (d ? -1 : 1) * (F + e.labelDistance) : c.getX(N < e.top + 2 || N > e.bottom - 2 ? h: N, d, e),
				B._attr = {
					visibility: O,
					align: g[6]
				},
				...
				g.x = P,
				g.y = N,
				u(l.crop, !0) && (G = B.getBBox().width, h = null, P - G < m ? (h = Math.round(G - P + m), y[3] = Math.max(h, y[3])) : P + G > t - m && (h = Math.round(P + G - t + m), y[1] = Math.max(h, y[1])), 0 > N - w / 2 ? y[0] = Math.max(Math.round( - N + w / 2), y[0]) : N + w / 2 > v && (y[2] = Math.max(Math.round(N + w / 2 - v), y[2])), B.sideOverflow = h)
			}), 0 === H(y) || this.verifyDataLabelOverflow(y)) && (this.placeDataLabels(), n && q(this.points,
			function(a) {
				var b;
				C = a.connector;
				if ((B = a.dataLabel) && B._pos && a.visible && 0 < a.labelDistance) {
					O = B._attr.visibility;
					if (b = !C) a.connector = C = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(c.dataLabelsGroup),
					C.attr({
						"stroke-width": n,
		...
		function() {
			...
			function(f) {
				...
				n = f.dataLabelCollections || ["dataLabel"]; (l.enabled || f._hasPointLabels) && !l.allowOverlap && f.visible && H(n,
				function(l) {
					H(f.points,
					function(f) {
		...
		B.prototype.hideOverlappingLabels = function(a) {
			...
			for (n = 0; n < f; n++) if (q = a[n]) q.oldOpacity = q.opacity,
			q.newOpacity = 1,
			q.width || (v = q.getBBox(), q.width = v.width, q.height = v.height);
			a.sort(function(a, b) {
				return (b.labelrank || 0) - (a.labelrank || 0)
			});
			for (n = 0; n < f; n++) for (v = a[n], q = n + 1; q < f; ++q) if (u = a[q], v && u && v !== u && v.placed && u.placed && 0 !== v.newOpacity && 0 !== u.newOpacity && (c = v.alignAttr, b = u.alignAttr, m = v.parentGroup, d = u.parentGroup, h = 2 * (v.box ? 0 : v.padding || 0), c = k(c.x + m.translateX, c.y + m.translateY, v.width - h, v.height - h, b.x + d.translateX, b.y + d.translateY, u.width - h, u.height - h)))(v.labelrank < u.labelrank ? v: u).newOpacity = 0;
			H(a,
			function(a) {
				var b, c;
		...
		n(m.prototype, {
			setItemEvents: function(a, b, c) {
				...
				h = "highcharts-legend-" + (a instanceof k ? "point": "series") + "-active"; (c ? b: a.legendGroup).on("mouseover",
				function() {
					a.setState("hover");
					f.addClass(h);
		...
		n(H.prototype, {
			showResetZoom: function() {
				...
				v(this, "beforeShowResetZoom", null,
				function() {
		...
		n(k.prototype, {
			...
			setState: function(a, b) {
				...
				if (! (a === this.state && !b || this.selected && "select" !== a || !1 === f.enabled || a && (g || m && !1 === p.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
					...
					this.graphic.animate(e.pointAttribs(this, a), h(t.options.chart.animation, f.animation)),
					z && this.graphic.animate(z, h(t.options.chart.animation, p.animation, k.animation)),
					q && q.hide();
					else {
						if (a && p) {
							k = r.symbol || e.symbol;
							...
							else k && (e.stateMarkerGraphic = q = t.renderer.symbol(k, z.x, z.y, z.width, z.height).add(e.markerGroup), q.currentSymbol = k);
		...
		n(e.prototype, {
			...
			setState: function(a) {
				...
				d.animate(f, h(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(f),
				c += 1
			},
			setVisible: function(a, b) {
				var c = this,
		...
		B.prototype.currentOptions = function(l) {
			function n(c, b, l, d) {
				...
				a.objectEach(c,
				function(a, c) {
					if (!d && -1 < E(c, ["series", "xAxis", "yAxis"])) for (a = t(a), l[c] = [], h = 0; h < a.length; h++) b[c][h] && (l[c][h] = {},
					n(a[h], b[c][h], l[c][h], d + 1));
					else f(a) ? (l[c] = q(a) ? [] : {},
					n(a, b[c] || {},
					l[c], d + 1)) : l[c] = b[c] || null
				})
			}
			var u = {};
