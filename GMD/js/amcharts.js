(function() {
	...
	d.AxisBase = d.Class({
		...
		addGuide: function(a) {
			...
			c = !1,
			e = b.length,
			g = 0; g < b.length; g++) b[g] == a && (c = !0, e = g);
	...
	d.ValueAxis = d.Class({
		...
		draw: function() {
			...
			this.positionTitle();
			"radar" != a.type && g.toFront(); ! this.visible || e ? (b.hide(), g.hide(), u.hide()) : (b.show(), g.show(), u.show());
			this.axisY = this.y;
			this.axisX = this.x
		},
		...
		getMinMax: function() {
			...
			e;
			for (e = 0; e < c.length; e++) {
				var g = c[e].type; ("line" == g || "step" == g || "smoothedLine" == g) && this.expandMinMax && (a = !0)
			}
	...
	d.RecItem = d.Class({
		construct: function(a, b, c, e, g, f, h, k, l, m, n, q) {
			...
			fa && (fa.translate(oa, Y), d.setCN(p, fa, a.bcn + "tick"), d.setCN(p, fa, q, !0), h && d.setCN(p, fa, "guide")); ! 1 === a.visible && (fa && fa.remove(), ca && (ca.remove(), ca = null));
			ca && (ca.attr({
				"text-anchor": ga
		...
		brr: function() {
			if (!this.hideCredits) {
				...
				if (c != a || !0 === this.inIframe()) {
					...
					e = "数据来源：国家数据";
					"ammap" == this.product && (c = a + "/javascript-maps/", b = "JavaScript maps", e = "数据来源：国家数据");
	...
	d.AmGraph = d.Class({
		...
		positionLabel: function(a, b, c, e, d) {
			if (e) {
				...
				if (e && "radar" != f.type) if (q) {
					...
					e = null; ! this.showAllValueLabels && e && (0 > b || b > this.width) && (e.remove(), e = null)
				} else {
				...
				if (Ia) {
					...
					case "line":
						if (isNaN(W)) z || (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = []);
							...
							Ea = F;
							ka = E;
							la = F; ! Ma || isNaN(N) || isNaN(O) || (T.push(O), U.push(N));
					...
					case "column":
						...
						if (!isNaN(W)) {
							...
							if (va) {
								...
								S = d.roundTo(S, 2);
								R = d.roundTo(R, 2);
								za.translate(S, R); (v.url || this.showHandOnHover) && za.setAttr("cursor", "pointer");
								if (!J) {
		...
		drawLineGraph: function(a, b, c, e) {
			...
			if (1 < a.length) {
				...
				z && (w = z);
				var x = g.dashLength; (z = g.dashLengthSwitched) && (x = z);
		...
		createBullet: function(a, b, c) {
			if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
				...
				if (p) { (a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer");
					if ("serial" == e.type || "gantt" == e.type) if ( - .5 > b || b > this.width || c < -h / 2 || c > this.height) p.remove(),
					p = null;
				...
				if (p) {
					p.size = h || 0;
					if (e = this.bulletHitAreaSize) g = d.circle(g, e, "red", .001, 0),
					g.translate(b, c),
					a.hitBullet = g,
	...
	d.ChartCursor = d.Class({
		...
		handleReleaseOutside: function() {
			...
			if (this.drawingNow) {
				...
				c = this.mouseX,
				e = this.mouseY,
				g = this.chart; (2 < Math.abs(a - c) || 2 < Math.abs(b - e)) && this.fire({
					type: "draw",
					target: this,
					chart: g,
					initialX: a,
	...
	d.SimpleChartScrollbar = d.Class({
		...
		dispatchScrollbarEvent: function() {
			if (this.skipEvent) this.skipEvent = !1;
				...
				if (this.percentStart != this.prevPercentStart || this.percentEnd != this.prevPercentEnd || this.prevMultiplier != d) this.fire(a),
		...
		createEntry: function(a) {
			if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
				...
				if (e) {
					...
					var z;
					isNaN(b.gradientRotation) || (z = 180 + b.gradientRotation); (m = b.createMarker(g, f, h, void 0, void 0, void 0, z, l)) && m.translate(p / 2, p / 2)
				}
